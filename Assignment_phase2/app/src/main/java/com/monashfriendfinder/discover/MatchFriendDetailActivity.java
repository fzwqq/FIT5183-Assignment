...
import com.monashfriendfinder.movie.favoriteMovie;
...
public class MatchFriendDetailActivity extends AppCompatActivity {
    ...
    public void displayMovie(){
        String favoriteMovie = "get by movie";
        Intent i = new Intent();
        i.setClass(this, com.monashfriendfinder.movie.favoriteMovie.class);
        i.putExtra("movie_name", favoriteMovie);
        startActivity(i);
    }
